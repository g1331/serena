...
class GetSymbolsOverviewTool(Tool, ToolMarkerSymbolicRead):
    ...
    def apply(self, relative_path: str, max_answer_chars: int = -1) -> str:
        ...
        result_json_str = json.dumps([dataclasses.asdict(i) for i in result], ensure_ascii=False)
...
class FindSymbolTool(Tool, ToolMarkerSymbolicRead):
    ...
    def apply(
        ...
        result = json.dumps(symbol_dicts, ensure_ascii=False)
...
class FindReferencingSymbolsTool(Tool, ToolMarkerSymbolicRead):
    ...
    def apply(
        ...
        result = json.dumps(reference_dicts, ensure_ascii=False)
        return self._limit_length(result, max_answer_chars)
